...
Configurare `NEXT_PUBLIC_POCKETBASE_URL`. Il client invia `POST /api/collections/visura_ai_events/records` con `experiment_id`, `variant_id`, `visitor_id`, `event_name`, `service_type` e `occurred_at`.
