          ...
          <GridItem xs={12} sm={12} md={8}>
            <GridContainer >
              {blockstack.map((post) => {
                ...
                let time = new Date(post.datetime).getHours() + ':' + new Date(post.datetime).getMinutes();
                return(
                <>
                  <GridItem xs={12} sm={12} md={6}>
                    <Card>
                      <CardHeader color="info"><b>{post.emotion}</b><br />{date} at {time}</CardHeader>
                      <CardBody>
                        <i>Giorgio Tedesco</i> says:
                        <p><b>{post.sentence}</b></p>
                      </CardBody>
                    </Card>
                  </GridItem>
                </>
              ...
              <GridItem xs={12} sm={12} md={6}>
                <Button as='link' href="/web-apps/messages/?giorgionetg.id.blockstack">READ MORE</Button>
              </GridItem>
