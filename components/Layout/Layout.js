    ...
    <React.Fragment>
      ...
      <div className={classNames(classes.main)}>
        ...
        <CookieConsent
          ...
          expires={365}
        >
          This website uses technical cookies to enhance the user experience.{" "}<br />
          <p style={{ fontWeight: 400 }}>I don't like to use your data. I will use only Technical Cookies to store your choice.</p>
          <Button as='link' href='/privacy'>Read more about Privacy and Cookies used here</Button>
        </CookieConsent>
